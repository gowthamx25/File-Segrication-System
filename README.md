...
⚠️ Important Notes on Missing / Excluded Files

.git/ directory
Not included in GitHub because it contains local repository metadata and is automatically managed by GitHub.

venv/ (Virtual Environment)
Present in the ZIP for local development, but should not be committed to GitHub as it is:

OS-specific

Auto-generated

Recreatable using dependency installation

Recommended practice: remove venv/ from GitHub and add it to .gitignore.
